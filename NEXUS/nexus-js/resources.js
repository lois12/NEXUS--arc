...
export async function loadResources() {
  try {
    ...
    // Перерисовываем только если модалка сейчас открыта
...
function renderResourceModal() {
  ...
  if (resourcesCache.length > 0) {
    ...
    // Если кэш пуст — грузим с сервера
    loadResources()
      .then(() => {
...
function drawResourceList(list) {
  ...
  // Привязка событий к новым элементам
...
// ============================================================================
// 🔹 ГЛОБАЛЬНЫЕ СОБЫТИЯ (Self-Contained)
// ============================================================================
nexusLinksBtn?.addEventListener("click", openResourceModal);
